...
status: live
order: 109
summary: "Use local search for enormous state spaces while treating local optima, plateaus, and randomness as first-class design issues."
---
...
**Related:** [Local Search: Hill Climbing, Plateaus, and Restarts](/learn/classical-ai/search-planning/110-local-search-hill-climbing-plateaus-and-restarts)
