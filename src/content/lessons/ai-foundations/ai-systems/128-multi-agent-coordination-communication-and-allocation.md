...
status: live
order: 128
summary: "Coordinate agents with local information while managing conflicts, communication cost, incentives, and shared constraints."
---
...
**Related:** [Multi-agent coordination and task allocation](/learn/classical-ai/agents-robotics/307-multi-agent-coordination-and-task-allocation), [Multi-Agent Patterns](/learn/agentic-ai/multi-agent-patterns)
