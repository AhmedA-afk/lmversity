...
**Related:** [Tool/Function Schemas](/learn/structured-outputs/tool-function-schemas), [Forcing a Tool Call to Extract](/learn/structured-outputs/function-calling-extraction-implementation), [JSON Mode: The Basics](/learn/structured-outputs/json-mode-basics), [Extraction Is Schema-Filling](/learn/structured-outputs/extraction-as-a-structured-output-problem), [Cross-Provider Structured Output Differences](/learn/structured-outputs/cross-provider-structured-output-differences); [What Is Tool Calling](/learn/tools-function-calling/what-is-tool-calling)
