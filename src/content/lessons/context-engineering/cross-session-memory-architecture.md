...
**Related:** [Memory vs State](/learn/context-engineering/memory-vs-state-distinction), [Structured Memory Stores](/learn/context-engineering/structured-memory-stores-compared), [What to Remember, What to Forget](/learn/context-engineering/what-to-remember-vs-forget), [Retrieval vs Context Stuffing](/learn/context-engineering/retrieval-vs-context-stuffing), [Just-in-Time Context Loading](/learn/context-engineering/just-in-time-context-loading); [Memory vs State: What Persists Across Turns and Sessions](/learn/context-engineering/conversation-memory-and-state)
