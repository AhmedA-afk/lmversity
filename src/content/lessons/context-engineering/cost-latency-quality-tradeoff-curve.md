...
**Related:** [Context Rot](/learn/context-engineering/context-rot), [Why More Tokens Hurt](/learn/context-engineering/why-more-tokens-hurt), [Retrieval vs. Context Stuffing](/learn/context-engineering/retrieval-vs-context-stuffing), [Budget as a Zero-Sum Pie](/learn/context-engineering/the-budget-allocation-mental-model); [Set SLOs for Latency, Cost, and Quality](/learn/production/latency-and-cost-slos) · [Cost and Token Budgets for Prompts](/learn/prompt-engineering/cost-and-token-budget-for-prompts)
