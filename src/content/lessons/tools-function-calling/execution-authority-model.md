...
**Related:** [Building a Registry and Dispatcher](/learn/tools-function-calling/building-a-tool-dispatcher), [Never Trust the Model's Arguments](/learn/tools-function-calling/validating-tool-arguments), [The Confused-Deputy Problem](/learn/tools-function-calling/the-authority-problem), [Tool Calling and Authority](/learn/genai-app-dev/tool-calling-and-authority), [Executing Tool Calls Safely](/learn/tools-function-calling/executing-tool-calls-safely); [Anatomy of a Tool Call](/learn/tools-function-calling/anatomy-of-a-tool-call)
