...
**Related:** [Anatomy of a Tool Call](/learn/tools-function-calling/anatomy-of-a-tool-call), [How Models Learn to Emit Tool Calls](/learn/tools-function-calling/how-models-learn-to-call-tools), [It's Still Text In, Text Out](/learn/tools-function-calling/tool-calling-still-text-in-text-out), [Validating Tool Arguments](/learn/tools-function-calling/validating-tool-arguments), [Your First Tool Call, End to End](/learn/tools-function-calling/first-tool-call-walkthrough), [Tool/Function Calling Across Providers — app-dev angle](/learn/genai-app-dev/function-calling-across-providers); [What Is Tool Calling](/learn/tools-function-calling/what-is-tool-calling)
