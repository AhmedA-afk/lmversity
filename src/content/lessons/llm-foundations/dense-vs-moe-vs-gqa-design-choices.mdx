...
**How it works.** Query heads are split into a handful of groups (commonly 8), each sharing one key/value pair — the middle-of-the-spectrum design from [From MHA to MQA: Why Grouped-Query Attention Won](/learn/llm-foundations/multi-query-and-grouped-query-attention).
...
**Related:** [From MHA to MQA: Why Grouped-Query Attention Won](/learn/llm-foundations/multi-query-and-grouped-query-attention), [Mixture of Experts: Routing](/learn/llm-foundations/mixture-of-experts-routing), [KV Cache Memory: MHA vs GQA vs MQA](/learn/llm-foundations/kv-cache-memory-mha-vs-gqa), [Misreading Parameter Counts](/learn/llm-foundations/misreading-parameter-counts)
