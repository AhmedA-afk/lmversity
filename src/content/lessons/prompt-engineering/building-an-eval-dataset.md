...
**Related:** [Why You Evaluate Before You Ship](/learn/prompt-engineering/why-eval-before-ship), [Rubric Scoring With an LLM Judge](/learn/prompt-engineering/rubric-and-llm-judge), [Regression Tests: Keeping a Golden Set Green](/learn/prompt-engineering/regression-tests-for-prompts), [Versioning Prompts Like Production Code](/learn/prompt-engineering/prompt-versioning-like-code) · [Building a Golden Dataset](/learn/evals-red-teaming/building-a-golden-dataset)
