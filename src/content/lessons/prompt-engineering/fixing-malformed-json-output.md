...
**Related:** [Structured Output: Making the Model Speak a Contract](/learn/prompt-engineering/structured-output-contracts), [Prefilling the Assistant Turn](/learn/prompt-engineering/prefilling-responses), [Why 'Don't Do X' Backfires](/learn/prompt-engineering/negative-instructions-pitfall), [Building a Validate-and-Repair Loop](/learn/prompt-engineering/validation-and-repair-loop), [Evaluating Prompts Before You Ship Them](/learn/prompt-engineering/prompt-evaluation-basics) · [Incremental JSON Repair: Fixing Truncated Output Instead of Discarding It](/learn/structured-outputs/incremental-json-repair)
