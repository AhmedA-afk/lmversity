...
**Related:** [When to Split One Prompt Into a Pipeline](/learn/prompt-engineering/when-to-split-a-prompt), [Structured Output: Making the Model Speak a Contract](/learn/prompt-engineering/structured-output-contracts), [Over-Decomposition: Too Many Stages](/learn/prompt-engineering/over-decomposition), [Worked Example: A Classify-Then-Extract Pipeline](/learn/prompt-engineering/classify-then-extract-pipeline) · [Context Handoff Between Agents: Passing the Slice, Not the Stack](/learn/context-engineering/context-handoff-between-agents)
