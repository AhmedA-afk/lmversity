...
**Related:** [Structured Output: Making the Model Speak a Contract](/learn/prompt-engineering/structured-output-contracts), [Prefilling the Assistant Turn](/learn/prompt-engineering/prefilling-responses), [Building a Validate-and-Repair Loop](/learn/prompt-engineering/validation-and-repair-loop), [Passing State Cleanly Between Pipeline Stages](/learn/prompt-engineering/passing-state-between-stages), [Prompt Portability Across Models](/learn/prompt-engineering/prompt-portability-across-models) · [Field Descriptions Are Inline Prompts](/learn/structured-outputs/field-descriptions-as-prompts) · [Descriptions Are Prompt Engineering](/learn/tools-function-calling/descriptions-are-prompts)
