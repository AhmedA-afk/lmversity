...
**Related:** [Prompt Caching for Speed and Cost](/learn/genai-app-dev/prompt-caching), [Token Accounting and Per-User Quotas](/learn/genai-app-dev/token-accounting-and-quotas), [Streaming, Caching, and Batching Together](/learn/genai-app-dev/streaming-caching-batching-together), [Cutting Cost With a Model Cascade](/learn/genai-app-dev/cutting-cost-with-model-cascade); [How Prompt Caching Works](/learn/context-engineering/prompt-caching-mechanics)
