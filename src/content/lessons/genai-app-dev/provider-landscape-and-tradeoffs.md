...
**Related:** [Why (and How Far) to Abstract the Provider](/learn/genai-app-dev/why-abstract-the-provider), [Building a Provider Abstraction Layer](/learn/genai-app-dev/provider-abstraction-layers), [Build Your Own Layer or Use a Gateway?](/learn/genai-app-dev/gateway-vs-in-app-abstraction), [Cost- and Capability-Aware Routing in Action](/learn/genai-app-dev/cost-and-capability-based-routing), [SDK vs. Raw API](/learn/genai-app-dev/sdk-vs-raw-api); [The Cross-Provider Landscape](/learn/structured-outputs/cross-provider-landscape)
