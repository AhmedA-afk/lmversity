...
**Related:** [Tool Calls Are Requests for Authority](/learn/genai-app-dev/tool-calling-as-authority), [Implementing the Tool-Call Loop](/learn/genai-app-dev/implementing-a-tool-call-loop), [Two Tools: A Read API and a Guarded DB Write](/learn/genai-app-dev/building-a-weather-and-db-tool), [Multi-Step Tool Loops and Where They Go Wrong](/learn/genai-app-dev/multi-step-agentic-tool-loops), [Guardrails and Input Validation](/learn/genai-app-dev/guardrails-and-input-validation); [What Is Tool Calling](/learn/tools-function-calling/what-is-tool-calling)
