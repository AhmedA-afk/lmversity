...
**Related:** [Generative UI: Declare-Then-Fill vs Guess-Then-Classify](/learn/genai-app-dev/generative-ui-rendering-components), [How Token Streaming Works End to End](/learn/genai-app-dev/streaming-response-fundamentals), [Structured Output in Apps](/learn/genai-app-dev/structured-output-in-apps), [Structured Output Failure Modes and How to Spot Them](/learn/genai-app-dev/structured-output-failures)
