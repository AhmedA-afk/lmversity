...
---
import FdeInterviewLoop from '../../../components/diagrams/FdeInterviewLoop.astro';
...
- For **Learning**, practise reading someone else's medium-sized codebase cold and shipping one working change inside an hour, with documentation open but no chance to ask the original author. Practise writing SQL, including [window functions](/roles/forward-deployed-engineer/foundations/window-functions-second-highest-per-category) and joins, without a database in front of you to check your work.
